...
class BotServlet < WEBrick::HTTPServlet::AbstractServlet
	...
	# A basic html template consisting of a basic page with a form and test entry box
	# for the user to conveerse with our bot. It uses some placeholder text (%RESPONSE%)
	# so the bot's responses can be substituted in easily later.
	@@html = %q{
		<html>
		<body>
			<form method="get">
